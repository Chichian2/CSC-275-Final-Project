...
SGPLATFORM_LIST = [(WIDTH, HEIGHT-80, 60, 20),
                 ...
                 (WIDTH+300, HEIGHT-80, 60, 20),
                 (WIDTH+300, (HEIGHT*3/4)-70, 60, 20),
                 (WIDTH+300, (HEIGHT/2)-60, 60, 20),
                 (WIDTH+300, (HEIGHT/4)-50, 60, 20)]
    #Machine Gun Level
...
#Crossbow Level
CBPLATFORM_LIST = [(WIDTH, (HEIGHT/2)+100, 400, 30),(WIDTH + 600, HEIGHT/2, 400, 30)]
...
#Boss images
BOSS_IMAGE = {'MachineGun':'Uzi.png','ShotGun':'Shotgun.png','CrossBow':'Crossbow.png'}
